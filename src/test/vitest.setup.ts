  ...
  useTranslation: () => ({
    t: (key: string, params?: Record<string, unknown>) => {
      ...
      const translations: Record<string, string> = {
        ...
        "approval.collapseUserInputRequest": "Collapse this input request card",
        "approval.collapsedUserInputRequest": "Collapsed input request card",
        "approval.expandUserInputRequest": "Expand",
        "approval.skipUserInputRequest": "Skip this request and continue the conversation",
        "approval.skipAndContinue": "Skip and continue",
