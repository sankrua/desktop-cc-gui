const enPart5 = {
  ...
  projectMap: {
    ...
    navigation: {
      ...
      summary: "{{tours}} tour steps · {{matches}} search matches · path {{pathStatus}}",
      expand: "Expand",
      collapse: "Collapse",
      search: {
        title: "Node search",
      ...
      tour: {
        title: "Guided tour",
        subtitle: "Walk from overview to architecture, risk, and task planning.",
        onboardingTitle: "Start from project overview",
        onboardingSummary: "Inspect the core node and main capability hubs first.",
        architectureTitle: "Review architecture relations",
        architectureSummary: "Follow hubs and relation-backed nodes to inspect boundaries and dependencies.",
        riskTitle: "Review risk and stale nodes",
        riskSummary: "Prioritize stale, low-confidence, and risk-signal nodes.",
        taskTitle: "Plan the next task",
        taskSummary: "Use candidate and risk nodes to choose what to complete or calibrate next.",
        stepCounter: "{{current}} / {{total}}",
        previous: "Previous",
        next: "Next",
        focus: "Focus",
        empty: "No guided tour steps are available.",
        badge: "tour",
      },
      path: {
        title: "Path finder",
    ...
    repair: {
      ...
      action: "Run deterministic repair",
    },
