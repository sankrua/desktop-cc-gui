const enPart5 = {
  ...
  projectMap: {
    ...
    collectFramework: "Collect profile",
    ...
    lensStats: "{{detected}} detected lenses · {{candidate}} candidate lenses",
    expandLenses: "Expand lenses",
    collapseLenses: "Collapse lenses",
    ...
    tasks: {
      ...
      phase: {
        ...
        completed: "Completed. The map has been refreshed.",
    ...
    settings: {
      ...
      subtitle: "Default mode creates candidates and does not directly mutate the active map.",
      autoIngestion: "Enable project-memory auto ingestion",
      threshold: "Threshold",
      applyMode: "Apply mode",
      createCandidate: "Create candidate",
      autoApplyEvidenceBacked: "Auto apply evidence-backed",
    },
    confirmation: {
