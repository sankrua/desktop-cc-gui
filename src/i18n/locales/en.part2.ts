const enPart2 = {
  ...
  approval: {
    ...
    collapseUserInputRequest: "Collapse this input request card",
    collapsedUserInputRequest: "Collapsed input request card",
    expandUserInputRequest: "Expand",
    skipUserInputRequest: "Skip this request and continue the conversation",
